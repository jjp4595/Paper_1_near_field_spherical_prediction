...
fig_dataset1.set_size_inches(2.8,2.5)
...
fig_dataset2.set_size_inches(2.8,2.5)
...
fig_dataset3.set_size_inches(2.8,2.5)
...
ax.plot(Apollo_gauges_z80mm_first[0][:,0]*1000, Apollo_gauges_z80mm_first[0][:,101]/1e3, 'r', label = '1.25mm')
...
ax1.plot(Apollo_gauges_z80mm_first[0][:,0]*1000, Apollo_gauges_z80mm_first[0][:,1]/1e6, 'r')
...
ax.plot(Apollo_gauges_z80mm_first[0][:,0]*1000, Apollo_gauges_z80mm_first[0][:,125]/1e3, 'r')
...
ax1.plot(Apollo_gauges_z80mm_first[0][:,0]*1000, Apollo_gauges_z80mm_first[0][:,25]/1e6, 'r')
...
ax.plot(Apollo_gauges_z80mm_first[0][:,0]*1000, Apollo_gauges_z80mm_first[0][:,150]/1e3, 'r')
...
ax1.plot(Apollo_gauges_z80mm_first[0][:,0]*1000, Apollo_gauges_z80mm_first[0][:,50]/1e6, 'r')
...
ax.plot(Apollo_gauges_z80mm_first[0][:,0]*1000, Apollo_gauges_z80mm_first[0][:,174]/1e3, 'r')
...
ax1.plot(Apollo_gauges_z80mm_first[0][:,0]*1000, Apollo_gauges_z80mm_first[0][:,74]/1e6, 'r')
...
ax.plot(Apollo_gauges_z80mm_first[0][:,0]*1000, Apollo_gauges_z80mm_first[0][:,198]/1e3, 'r')
...
ax1.plot(Apollo_gauges_z80mm_first[0][:,0]*1000, Apollo_gauges_z80mm_first[0][:,98]/1e6, 'r')
