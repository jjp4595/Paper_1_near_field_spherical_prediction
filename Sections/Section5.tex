...
A comparison of the near-field predictive methods is shown below in Figure \ref{fig:theta_peak_impulsei_theta_comparisons}. 
...
\begin{figure}[htpb]
	...
	\label{fig:theta_peak_impulsei_theta_comparisons}
\end{figure}
