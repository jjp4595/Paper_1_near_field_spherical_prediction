...
\begin{figure}[htpb]
	...
	\end{subfigure}	
	\caption{Peak specific impulse distribution overview of PE4 datasets.}
\end{figure}
...
\begin{figure}[htpb]
	...
	\caption{Fitting a power law to the peak specific impulse data ($0.05m/kg^{1/3} \leq z \leq 0.16 m/kg^{1/3}$) and an assessment of the fit.}
	\label{fig:power_fit}
\end{figure}

\begin{figure}[htpb]
	\centering
	\includegraphics{Graphs/power_fit2.pdf}
	\caption{Fitting a power law to the peak specific impulse data ($0.05m/kg^{1/3} \leq z \leq 0.5 m/kg^{1/3}$) and an assessment of the fit.}
	\label{fig:power_fit2}
\end{figure}
...
\begin{figure}[htpb]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics{Graphs/smallz_henrych1.pdf}
		\caption{Constructed surface from Henrych/Remennikov model}
		\label{fig:smallz_henrych1}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics{Graphs/smallz_henrych2.pdf}
		\caption{CFD residual}
		\label{fig:smallz_henrych2}
	\end{subfigure}

	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics{Graphs/smallz_RPB1.pdf}
		\caption{Constructed surface from RPB-MCEER model}
		\label{fig:smallz_RPB1}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics{Graphs/smallz_RPB2.pdf}
		\caption{CFD residual}
		\label{fig:smallz_RPB2}
	\end{subfigure}
...
\begin{figure}[htpb]
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics{Graphs/largez_henrych1.pdf}
		\caption{Constructed surface from Henrych/Remennikov model}
		\label{fig:largez_henrych1}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
	...
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics{Graphs/largez_RPB1.pdf}
		\caption{Constructed surface from RPB-MCEER model}
		\label{fig:largez_RPB1}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics{Graphs/largez_RPB2.pdf}
		\caption{CFD residual}
		\label{fig:largez_RPB2}
	\end{subfigure}
