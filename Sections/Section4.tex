...
\begin{figure}[htpb]
	...
	\end{subfigure}
	\caption{Peak specific impulse distribution overview of PE4 datasets. $0.05m/kg^{1/3} \leq z \leq 0.16 m/kg^{1/3}$, $0.05m/kg^{1/3} \leq z\text{(clear standoff)} \leq 0.16 m/kg^{1/3}$}
\end{figure}
...
\begin{figure}
	\begin{subfigure}[htpb]{\textwidth}
		...
		\vspace{3mm}
		\caption{Gaussian 1 model. \textbf{MUST TALK ABOUT THE NORMALISED ANGLES ON THE BOTTOM AXIS!}}
