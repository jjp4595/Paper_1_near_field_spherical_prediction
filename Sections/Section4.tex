...
\begin{figure}[htpb]
	...
	\caption{Modelling peak impulse distribution in angle of incidence.}
...
\begin{figure}[htpb]
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics{Graphs/theta_predictor_residuals_a.pdf}
		\caption{Gaussian-single.}
		\label{fig:theta_predictor_residuals_a}
	\end{subfigure}
	\begin{subfigure}{0.45\textwidth}
		\centering
		\includegraphics{Graphs/theta_predictor_residuals_b.pdf}
		\caption{Gaussian-double}
		\label{fig:theta_predictor_residuals_b}
	\end{subfigure}	
	\caption{Residual assessment of Gaussian models.}
\end{figure}