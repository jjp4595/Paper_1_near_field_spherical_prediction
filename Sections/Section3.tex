...
Central detonations, afterburn (yes/no? which version?) which detonation model? Also should probably put in the EOS JWL and the parameters apollo uses for PE4
