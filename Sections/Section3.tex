...
\begin{figure}[htpb]
	...
	\begin{subfigure}{\linewidth}
 	...
 	\end{subfigure}
	\caption{Mesh convergence study for peak impulse at various ultimate cell lengths for the lower bound and upper bound scaled distance for the dataset studied}
...
\begin{figure}[htpb]
	...
	\end{subfigure}
	\caption{Experimental validation for overpressure and impulse time histories at z=0.11 $m.kg^{\frac{1}{3}}$ for various angles of incidence.}
...
This result is interesting as it suggests the peak specific impulse distribution (as a proportion of its maximum at theta $=0$) is invariant to scaled distance. 
