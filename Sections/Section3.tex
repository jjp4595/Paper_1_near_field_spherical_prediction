...
The user can define termination criteria for each stage which may be a global pressure criterion or the normal restriction of stage radii having been met.
Successive stages are linked together through remapping of the flow field reached at the end of the prior stage onto the mesh of the successive stage.

Resolution levels can also be defined for each stage.
For instance if the overall simulation was split into three stages, each successive stage could permit an extra resolution level. 
This gives the user control over the level of refinement at each stage.
